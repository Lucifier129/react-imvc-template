...
var _AnimateLayout = require('../component/AnimateLayout');

var _AnimateLayout2 = _interopRequireDefault(_AnimateLayout);
...
var _class = function (_Controller) {
    ...
    function _class() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.BaseView = _AnimateLayout2.default, _this.View = View, _this.initialState = initialState, _this.handleChangeAnimateType = function (_ref2) {
            var currentTarget = _ref2.currentTarget;

            var animateType = currentTarget.getAttribute('data-animation');
            _this.cookie('animateType', animateType);
            _this.history.push('/advanced_usage/page_transition/b');
